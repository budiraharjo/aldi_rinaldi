...
<div style="background:#fafafa;padding:2px;width:100%;">
	    <form id="ff" method="post" novalidate>
			...
			<tr class="fitem">
	            <td width="15%"><label for="name">Nama</label></td>
	            <td><input class="easyui-validatebox" type="text" name="name" required="true" style="color: #333333"></input></td>
	        </tr>
	       <tr class="fitem">
	            <td><label for="email">Email</label></td>
	            <td><input class="easyui-validatebox" type="text" name="email" validType="email" style="color: #333333"></input></td>
	        </tr>
	        <tr class="fitem">
	            <td><label for="message">Komentar</label></td>
	            <td><textarea name="message" style="height:100px; color: #333333"></textarea></td>
	        </tr>
			<tr>
	            <td>
				<img src="res/captcha/image.php" />
				</td>
	            <td> = <input class="easyui-validatebox" type="text" name="secure" style="width: 50px;"></input></td>
	        </tr>
	        <tr style="padding: 20px;text-align: center;">
	            <td colspan="2">
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" onclick="submit()">Kirim</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-reload" onclick="javascript:$('#ff').form('clear');">Ulang</a>
	        </tr>
			</table>
	    </form>
	</div>
